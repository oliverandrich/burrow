// Command burrow-tailwind invokes the standalone Tailwind v4 CLI with a
...
// templates. It is a thin wrapper: arguments after the binary name are
// forwarded verbatim to `tailwindcss`.
//
// Typical use in a project's build pipeline:
//
//	go tool burrow-tailwind -i tailwind.css -o static/app.min.css
