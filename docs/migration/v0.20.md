...
If your shell app sits at `internal/app/` and owns `app/app.min.css` (the [Tailwind guide convention](../guide/tailwind.md#why-the-shell-is-in-internalapp)), it just works. If your CSS lives somewhere else, override:
